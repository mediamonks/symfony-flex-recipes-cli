// Package semver A small adaptation of the original semver code to work with version without v.
package semver
...
// Major returns the major version prefix of the semantic version.
